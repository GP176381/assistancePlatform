							...
							<el-col :xs="24" :sm="12" :md="6" :lg="4">
								<div class="up-file">
									<el-upload class="avatar-uploader" action="https://jsonplaceholder.typicode.com/posts/" :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
										<img v-if="form.idcardImg" :src="idcardImg" class="avatar">
						...
						<el-row>
							<el-dialog title="收货地址" :visible.sync="dialogFormVisible">
								<el-form ref="form.ydfpbqcyForm" :rules="form.ydfpbqcyRules" :model="form.ydfpbqcyForm" :label-width="formLabelWidth" :label-position="labelPosition">
									...
									<el-col :xs="24" :sm="24" :md="12" :lg="12">
										<el-form-item label="出生日期" prop="birthdays">
											<el-date-picker v-model="form.ydfpbqcyForm.birthdays" align="right" type="date" placeholder="选择日期" :picker-options="form.ydfpbqcyForm.pickerBirthday">
											</el-date-picker>
										</el-form-item>
									</el-col>
						...
						<el-row>
							<template>
								<el-table ref="multipleTable" :data="form.ydfpbqcyTable" border tooltip-effect="dark" style="width: 100%" @selection-change="handleYDFPBQCYTable">
									...
									<el-table-column prop="birthdays" label="出生日期">
									</el-table-column>
	...
	export default {
		...
		methods: {
			...
			handleAvatarSuccess(res, file) {
				this.idcardImg = URL.createObjectURL(file.raw);
			},
